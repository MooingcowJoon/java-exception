...
//			//		- 예외를 일괄처리하는 main메소드에서 처리할 예외의 갯수가 너무 많아진다.
//	
//	
...
//	
	...
	///////////////////////////////
	///	예외 전환하기를 사용한 경우
	//	 	- 메인 메소드에서 호출하는 모든 메ㅗ소드들이 exception 예외를 발생하도록
	//			싲레 발생한 예외객체는 catch 블록을 이용해서 가로챘다
	//		-	throw 키워드를 이용해서 Exception 예외를 강제 발생시켰다.
	//		- main 메소드에ㅓㅅ 호출하는 모든 메소드들이 Exception 예외를 발생시키기 때문에
